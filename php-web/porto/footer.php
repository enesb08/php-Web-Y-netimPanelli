<footer class="short" id="footer">
					...
					<div class="row">
						...
						<div class="col-md-3 col-md-offset-1">
							...
							<ul class="list list-icons mt-xl">
								...
								<li><i class="fa fa-envelope"></i> <strong>Mail:</strong> <a href="mailto:"><?php echo  $ayarcek['ayar_mail']; ?></a></li>
							</ul>
						</div>
						<div class="col-md-3">
							...
							<ul class="social-icons mt-lg">
								...
								<li class="social-icons-twitter"><a href="<?php echo $ayarcek['ayar_twiter']  ?>"  target="_blank" title="Twitter"><i class="fa fa-twitter"></i></a></li>
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2017. All Rights Reserved. | <a href="http://enesbaskaya.blogspot.com.tr/" target="_blank"> <?php echo $ayarcek['ayar_author']; ?> </a></p>
							</div>
						</div>
					</div>
				</div>
